jQuery(document).ready(function($) {
	...
	$('body').on('click','#activity-add-button', function () {
		...
		//End removing the fields
		$("#activity-fields").find('tbody').append('<tr><td><div class="form-group"><input type="text" name="activity_name_set['+counter_activity+']" class="form-control" value="'+activity_name+'" id="activity_name'+counter_activity+'"></div></td><td>'+activity_type+'</td><td><input type="checkbox" name="activity_advanced['+counter_activity+']"'+(activity_advance==1? 'checked ' : '')+'id="advance['+counter_activity+']" value="'+activity_advance+'"></td><td class="btn"><input type="button" value="Remove" class="btn-sm btn-danger btn-remove" id="activity-remove-button['+counter_activity+']"></td></tr>');
